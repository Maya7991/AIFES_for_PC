...
#define AIDEBUG_ENABLE_PRINTING /**< Enable printing to the console (switch off to save memory) */
    ...
    #define AISTRING_STORAGE_WRAPPER(S, VAR)     static const char S[] = VAR /**< Specifies the storage type of strings like logs or names */
    ...
    #define AISTRING_STORAGE_WRAPPER(S, VAR)       /**< Specifies the storage type of strings like logs or names */
